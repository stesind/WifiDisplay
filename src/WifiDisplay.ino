...
void loop() {
        ...
        if (readEnvironment) {
                ...
                if (enableDht) {
                        ...
                        pfTemp[ulMeasCount%ulNoMeasValues] = dht.readTemperature() + DHTTEMPOFFSET;
...
void writeDisplay() {
        ...
        if ((enableDht)) {
                ...
                temperature = dht.readTemperature() + DHTTEMPOFFSET; //Temperatur auslesen
  ...
  <body>\
    <h1><a href=\"/\">";
        ...
        if (enableDht) {
                ...
                float temperature = dht.readTemperature() + DHTTEMPOFFSET; //Temperatur auslesen
